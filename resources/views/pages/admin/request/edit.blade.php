                            ...
                            <form action="{{ route('request.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Nomor</label>
                                            <input type="text"  value="{{ $item->id }}" name="nomor" class="form-control" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group form-2">
                                            ...
                                            <textarea row="5" required type="text" name="tujuan" id="tujuan" class="form-control">{{ $item->tujuan }}</textarea>
                                        </div>
                                    </div>
