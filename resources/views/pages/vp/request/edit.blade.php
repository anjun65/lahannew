                            ...
                            <form action="{{ route('request-vp.update', $item->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Nomor</label>
                                            <input type="text"  value="{{ $item->id }}" name="nomor" class="form-control" disabled>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group form-2">
                                            ...
                                            <textarea row="5" disabled type="text" name="tujuan" id="tujuan" disabled class="form-control">{{ $item->tujuan }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control">
                                                ...
                                                <option value="{{  $item->status }}" disabled>Pilih Status</option>
