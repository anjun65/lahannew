                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="akhir_pelaksanaan" class="form-control" required value="{{ $item->tanggal_tanam }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="awal_pelaksanaan" class="form-control" required value="{{ $item->awal_pelaksanaan }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Akhir Pelaksanaan</label>
                                            <input type="email" name="akhir_pelaksanaan" class="form-control" required value="{{ $item->akhir_pelaksanaan }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Blok</label>
                                            <input type="email" name="blok" class="form-control" required value="{{ $item->blok }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="areal" class="form-control" required value="{{ $item->komoditas }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="areal" class="form-control" required value="{{ $item->varietas }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="areal" class="form-control" required value="{{ $item->peralatan }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="areal" class="form-control" required value="{{ $item->jumlah_peralatan }}">
                                        </div>
                                    </div>
