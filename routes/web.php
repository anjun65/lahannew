...
Route::prefix('admin')
    ...
    ->group(function(){
        ...
        Route::get('/process-request', [App\Http\Controllers\Admin\ProcessRequestController::class,'index'])->name('process-request');
        Route::get('/done-request', [App\Http\Controllers\Admin\DoneRequestController::class,'index'])->name('done-request');
    });
...
Route::prefix('vp')
    ...
    ->group(function(){
        ...
        Route::get('/process-request', [App\Http\Controllers\vp\ProcessRequestController::class,'index'])->name('vp-process-request');
        Route::get('/done-request', [App\Http\Controllers\vp\DoneRequestController::class,'index'])->name('vp-done-request');
    });
